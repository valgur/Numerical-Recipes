...
struct Amebsa {
  ...
  MatDoub p;
  Doub tt;
  Amebsa(VecDoub_I &point, const Doub del, T &funkk, const Doub ftoll) : funk(funkk), ftol(ftoll), ran(1234),
  ...
  Amebsa(VecDoub_I &point, VecDoub_I &dels, T &funkk, const Doub ftoll) : funk(funkk), ftol(ftoll), ran(1234),
                                                                          yb(numeric_limits<Doub>::max()), ndim(point.size()), pb(ndim),
                                                                          mpts(ndim + 1), y(mpts), p(mpts, ndim) {
    for (Int i = 0; i < mpts; i++) {
      for (Int j = 0; j < ndim; j++)
  ...
  Amebsa(MatDoub_I &pp, T &funkk, const Doub ftoll) : funk(funkk),
                                                      ...
                                                      ndim(pp.ncols()), pb(ndim), mpts(pp.nrows()), y(mpts), p(pp) { inity(); }
