...
struct Midpnt : Quadrature {
  Doub a, b, s;
  T &funk;
  Midpnt(T &funcc, const Doub aa, const Doub bb) : funk(funcc), a(aa), b(bb) { n = 0; }
  Doub next() {
    Int it, j;
...
struct Midinf : Midpnt<T> {
  ...
  Midinf(T &funcc, const Doub aa, const Doub bb) : Midpnt<T>(funcc, aa, bb) {
    Midpnt<T>::a = 1.0 / bb;
    Midpnt<T>::b = 1.0 / aa;
  }
};
...
struct Midsql : Midpnt<T> {
  ...
  Midsql(T &funcc, const Doub aa, const Doub bb) : Midpnt<T>(funcc, aa, bb), aorig(aa) {
    Midpnt<T>::a = 0;
...
struct Midsqu : Midpnt<T> {
  ...
  Midsqu(T &funcc, const Doub aa, const Doub bb) : Midpnt<T>(funcc, aa, bb), borig(bb) {
    Midpnt<T>::a = 0;
    Midpnt<T>::b = sqrt(bb - aa);
  }
};
...
struct Midexp : Midpnt<T> {
  ...
  Midexp(T &funcc, const Doub aa, const Doub bb) : Midpnt<T>(funcc, aa, bb) {
    Midpnt<T>::a = 0.0;
    Midpnt<T>::b = exp(-aa);
  }
};
